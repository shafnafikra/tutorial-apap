...
export default function Item(props) {
  ...
  return (
    <div className="list-group-item list-group-item-action d-flex align-items-center justify-content-between flex-row w-100 mb-3">
      <div className="d-flex">
        ...
        <div>
          <div className="d-flex justify-content-between align-items-center">
            <h5 className="mb-1 font-weight-bold">{title}</h5>
          </div>
