...
public class BioskopRestServiceImpl implements BioskopRestService {
    ...
    public Mono<String> getStatus(Long noBioskop){
        return this.webClient.get().uri( "rest/bioskop/" + noBioskop + "/status").retrieve().bodyToMono(String.class);
    ...
    public Mono<BioskopDetail> postStatus(){
        ...
        return this.webClient.post().uri("/rest/bioskop/full").syncBody(data)
                .retrieve()
